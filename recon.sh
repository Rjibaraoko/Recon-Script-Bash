...
domain=$1
RED="\033[1;31m"
#this is going to reset the command line
RESET="\033[0m"
...
#cat is read the found file extract domain uniquely sort use http probe extract https and eliminate https and show it in the command line
...
nmap -iL $subdomain_path/alive.txt -T4 -A -p-
#-iL = scan in list